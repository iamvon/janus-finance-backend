const SEARCH_OPTION_DEFAULT_LIMIT = 20
const SEARCH_OPTION_DEFAULT_PAGE = 1
const SEARCH_OPTION_DEFAULT_RADIX = 10
const SEARCH_OPTION_DEFAULT_SORT_DESCENDING = 1
const SEARCH_OPTION_MAX_LIMIT = 50
  ...
  Object.keys(queryString).forEach((key) => {
    if (isValidField(key, validFields)) {
      if (checkSearch(key)) {
        ...
        const isNumber = isNumeric(queryString[key]);
